...
%Plot_VorMod_Grad Plots approximation with a gradient on the points
    ...
    scatter(BS(BS_load>4*BS_cap/5 & BS_load<=1.0001*BS_cap, 1), BS(BS_load>4*BS_cap/5 & BS_load<=1.0001*BS_cap, 2), '^', 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k')
    scatter(BS(BS_load>1.0001*BS_cap, 1), BS(BS_load>1.0001*BS_cap, 2), 100, 'h', 'MarkerFaceColor', 'm', 'MarkerEdgeColor', 'k')
    view(0, 90)
    hold off
